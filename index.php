      ...
      <div class="row">
        <div class="col-sm-6 text-black">
          ...
          <div class="px-5 ms-xl-1 mt-4">      
            ...
            <span class="h2  mb-0" style="color: #03643a;">Zafiro</span>
          </div>
          ...
          <div class="d-flex align-items-center h-custom-3 px-5 ms-xl-4 mt-5 pt-5 pt-xl-12 mt-xl-n5">
            ...
            <form style="width: 40rem; text-align: center; ">
              ...
              <h2 class="fw-normal mb-3 pb-3 fw-bold title" >Bienvenido al residencial zafiro</h2>  
        ...
        <div class="col-sm-6 px-0 d-none d-sm-block">
          <img src="./img/zafiro.png" alt="Login image" class="w-100 vh-100 shadow " style="object-fit:cover; object-position: center;">
        </div>
      </div>
    </div>
  </section>
